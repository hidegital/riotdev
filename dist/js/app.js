...
var _home = require('./components/home.jade');

var _home2 = _interopRequireDefault(_home);

var _app = require('./components/app.jade');

var _app2 = _interopRequireDefault(_app);

var _notFound = require('./components/not-found.jade');
...
_riot2.default.router.routes([new DefaultRoute({ tag: 'test1' })]);

_riot2.default.router.start();

},{"./components/app.jade":4,"./components/home.jade":5,"./components/not-found.jade":6,"riot":2,"riot-router":1}],4:[function(require,module,exports){
var riot = require('riot');
module.exports = 
riot.tag2('app', '<div class="container"><ul class="row"><li><a href="#">Dashboard</a></li><li><a href="#/company">Company</a></li><li><a href="#/users">Users</a></li><li><a href="#/gallery">Gallery</a></li><route></route></ul></div>', '', '', function(opts) {
});
},{"riot":2}],5:[function(require,module,exports){
var riot = require('riot');
module.exports = 
riot.tag2('home', '<p>home</p>', '', '', function(opts) {
});
},{"riot":2}],6:[function(require,module,exports){
var riot = require('riot');
module.exports = 
riot.tag2('notfound', '<p>not-found</p>', '', '', function(opts) {
});
},{"riot":2}]},{},[3]);
